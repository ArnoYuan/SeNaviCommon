...
namespace NS_NaviCommon
{
  ...
  template<class ContainerAllocator>
    struct IsMessage<NS_ServiceType::ServiceTransform_<ContainerAllocator> const> : TrueType
    {
    };
  ...
  template<class ContainerAllocator>
    struct HasHeader<NS_ServiceType::ServiceTransform_<ContainerAllocator> const> : FalseType
    {
    };
