...
{
  template<class ContainerAllocator>
    struct IsFixedSize<NS_ServiceType::ServiceMap_<ContainerAllocator> > : FalseType
    {
    };
  
  template<class ContainerAllocator>
    struct IsFixedSize<NS_ServiceType::ServiceMap_<ContainerAllocator> const> : FalseType
    {
    };
  
  template<class ContainerAllocator>
    struct IsMessage<NS_ServiceType::ServiceMap_<ContainerAllocator> > : TrueType
    {
    };
  
  template<class ContainerAllocator>
    struct IsMessage<NS_ServiceType::ServiceMap_<ContainerAllocator> const> : TrueType
    {
    };
  
  template<class ContainerAllocator>
    struct HasHeader<NS_ServiceType::ServiceMap_<ContainerAllocator> > : FalseType
    {
    };
  
  template<class ContainerAllocator>
    struct HasHeader<NS_ServiceType::ServiceMap_<ContainerAllocator> const> : FalseType
    {
    };
  ...
  template<class ContainerAllocator>
    struct MD5Sum<NS_ServiceType::ServiceMap_<ContainerAllocator> >
    {
      ...
      static const char*
      value (const NS_ServiceType::ServiceMap_<ContainerAllocator>&)
      {
        return value ();
      }
...
namespace NS_NaviCommon
{
  ...
  template<class ContainerAllocator>
    struct Serializer<NS_ServiceType::ServiceMap_<ContainerAllocator> >
    {
      ...
      DECLARE_ALLINONE_SERIALIZER}; // struct ServiceMap_
