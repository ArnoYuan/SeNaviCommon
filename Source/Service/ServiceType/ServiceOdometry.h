...
{
  template<class ContainerAllocator>
    struct IsFixedSize<NS_ServiceType::ServiceOdometry_<ContainerAllocator> > : TrueType
    {
    };
  
  template<class ContainerAllocator>
    struct IsFixedSize<
        NS_ServiceType::ServiceOdometry_<ContainerAllocator> const> : TrueType
    {
    };
  
  template<class ContainerAllocator>
    struct IsMessage<NS_ServiceType::ServiceOdometry_<ContainerAllocator> > : TrueType
    {
    };
  
  template<class ContainerAllocator>
    struct IsMessage<NS_ServiceType::ServiceOdometry_<ContainerAllocator> const> : TrueType
    {
    };
  
  template<class ContainerAllocator>
    struct HasHeader<NS_ServiceType::ServiceOdometry_<ContainerAllocator> > : FalseType
    {
    };
  
  template<class ContainerAllocator>
    struct HasHeader<NS_ServiceType::ServiceOdometry_<ContainerAllocator> const> : FalseType
    {
    };
  ...
  template<class ContainerAllocator>
    struct MD5Sum<NS_ServiceType::ServiceOdometry_<ContainerAllocator> >
    {
      ...
      static const char*
      value (const NS_ServiceType::ServiceOdometry_<ContainerAllocator>&)
      {
        return value ();
      }
...
namespace NS_NaviCommon
{
  ...
  template<class ContainerAllocator>
    struct Serializer<NS_ServiceType::ServiceOdometry_<ContainerAllocator> >
    {
