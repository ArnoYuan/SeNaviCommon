...
template <class ContainerAllocator>
struct IsFixedSize< NS_DataType::Quaternion_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< NS_DataType::Quaternion_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< NS_DataType::Quaternion_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< NS_DataType::Quaternion_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< NS_DataType::Quaternion_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< NS_DataType::Quaternion_<ContainerAllocator> const>
  : FalseType
  { };
...
struct MD5Sum< NS_DataType::Quaternion_<ContainerAllocator> >
{
  ...
  static const char* value(const NS_DataType::Quaternion_<ContainerAllocator>&) { return value(); }
...
namespace NS_NaviCommon
{
  ...
  template<class ContainerAllocator> struct Serializer< NS_DataType::Quaternion_<ContainerAllocator> >
  {
