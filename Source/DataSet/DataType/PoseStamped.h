...
template <class ContainerAllocator>
struct IsFixedSize< NS_DataType::PoseStamped_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< NS_DataType::PoseStamped_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< NS_DataType::PoseStamped_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< NS_DataType::PoseStamped_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< NS_DataType::PoseStamped_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< NS_DataType::PoseStamped_<ContainerAllocator> const>
  : TrueType
  { };
...
struct MD5Sum< NS_DataType::PoseStamped_<ContainerAllocator> >
{
  ...
  static const char* value(const NS_DataType::PoseStamped_<ContainerAllocator>&) { return value(); }
...
namespace NS_NaviCommon
{
  ...
  template<class ContainerAllocator> struct Serializer< NS_DataType::PoseStamped_<ContainerAllocator> >
  {
