...
template <class ContainerAllocator>
struct IsFixedSize< NS_DataType::Vector3_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< NS_DataType::Vector3_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< NS_DataType::Vector3_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< NS_DataType::Vector3_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< NS_DataType::Vector3_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< NS_DataType::Vector3_<ContainerAllocator> const>
  : FalseType
  { };
...
struct MD5Sum< NS_DataType::Vector3_<ContainerAllocator> >
{
  ...
  static const char* value(const NS_DataType::Vector3_<ContainerAllocator>&) { return value(); }
...
namespace NS_NaviCommon
{
  ...
  template<class ContainerAllocator> struct Serializer< NS_DataType::Vector3_<ContainerAllocator> >
  {
