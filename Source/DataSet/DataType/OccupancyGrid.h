...
template <class ContainerAllocator>
struct IsFixedSize< NS_DataType::OccupancyGrid_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< NS_DataType::OccupancyGrid_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< NS_DataType::OccupancyGrid_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< NS_DataType::OccupancyGrid_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< NS_DataType::OccupancyGrid_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< NS_DataType::OccupancyGrid_<ContainerAllocator> const>
  : TrueType
  { };
...
struct MD5Sum< NS_DataType::OccupancyGrid_<ContainerAllocator> >
{
  ...
  static const char* value(const NS_DataType::OccupancyGrid_<ContainerAllocator>&) { return value(); }
...
namespace NS_NaviCommon
{
  template<class ContainerAllocator> struct Serializer< NS_DataType::OccupancyGrid_<ContainerAllocator> >
  {
