  ...
  template<typename DataType>
    ...
    private:
      ...
      makeSrv ()
      {
        ...
        try
        {
          shared_memory_object oper_shm (open_or_create, dataset_name.c_str (),
                                         read_write);
        ...
        active = true;
        dataset_thread = boost::thread (
            boost::bind (&Subscriber::processor, this));
      ...
      getSrv ()
      {
        ...
        shared_memory_object ds_shm (open_only, ds_shm_name.c_str (),
                                     read_write);
      ...
      processor ()
      {
        while (active)
        {
          if (operation)
          {
            ...
            {
              timeout = operation->req_cond.timed_wait (
                  lock,
