...
struct VectorSerializer<T, ContainerAllocator, typename boost::disable_if<NS_NaviCommon::IsFixedSize<T> >::type >
{
 ...
 */
template<typename T, class ContainerAllocator>
struct VectorSerializer<T, ContainerAllocator, typename boost::enable_if<NS_NaviCommon::IsSimple<T> >::type >
{
  typedef std::vector<T, typename ContainerAllocator::template rebind<T>::other> VecType;
  typedef typename VecType::iterator IteratorType;
  typedef typename VecType::const_iterator ConstIteratorType;
 ...
 */
template<typename T, class ContainerAllocator>
struct VectorSerializer<T, ContainerAllocator, typename boost::enable_if<mpl::and_<NS_NaviCommon::IsFixedSize<T>, mpl::not_<NS_NaviCommon::IsSimple<T> > > >::type >
{
  typedef std::vector<T, typename ContainerAllocator::template rebind<T>::other> VecType;
  typedef typename VecType::iterator IteratorType;
  typedef typename VecType::const_iterator ConstIteratorType;
...
struct ArraySerializer<T, N, typename boost::disable_if<NS_NaviCommon::IsFixedSize<T> >::type>
{
 ...
 */
template<typename T, size_t N>
struct ArraySerializer<T, N, typename boost::enable_if<NS_NaviCommon::IsSimple<T> >::type>
{
  typedef boost::array<T, N > ArrayType;
  typedef typename ArrayType::iterator IteratorType;
  typedef typename ArrayType::const_iterator ConstIteratorType;
 ...
 */
template<typename T, size_t N>
struct ArraySerializer<T, N, typename boost::enable_if<mpl::and_<NS_NaviCommon::IsFixedSize<T>, mpl::not_<NS_NaviCommon::IsSimple<T> > > >::type>
{
  typedef boost::array<T, N > ArrayType;
  typedef typename ArrayType::iterator IteratorType;
  typedef typename ArrayType::const_iterator ConstIteratorType;
