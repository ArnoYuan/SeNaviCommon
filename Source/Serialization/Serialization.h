...
namespace NS_NaviCommon
{
  ...
  template<typename T>
    struct Serializer
    {
      ...
      template<typename Stream>
        inline static void
        write (Stream& stream, typename boost::call_traits<T>::param_type t)
        {
      ...
      template<typename Stream>
        inline static void
        read (Stream& stream, typename boost::call_traits<T>::reference t)
        {
      ...
      serializedLength (typename boost::call_traits<T>::param_type t)
      {
  ...
  template<typename T, typename Stream>
    inline void
    serialize (Stream& stream, const T& t)
    {
...
#define CREATE_SIMPLE_SERIALIZER_ARM(Type) \
  ...
  template<>
    struct Serializer<bool>
    {
      template<typename Stream>
        inline static void
        write (Stream& stream, const bool v)
        {
          uint8_t b = (uint8_t) v;
#if defined(__arm__) || defined(__arm)
  ...
  template<class ContainerAllocator>
        ...
        std::basic_string<char, std::char_traits<char>, ContainerAllocator> >
    {
      ...
      template<typename Stream>
        inline static void
        write (Stream& stream, const StringType& str)
        {
          size_t len = str.size ();
      ...
      template<typename Stream>
        inline static void
        read (Stream& stream, StringType& str)
        {
          uint32_t len;
          stream.next (len);
          if (len > 0)
      ...
      inline static uint32_t
      serializedLength (const StringType& str)
      {
  ...
  template<>
    struct Serializer<NS_NaviCommon::Time>
    {
      template<typename Stream>
        inline static void
        write (Stream& stream, const NS_NaviCommon::Time& v)
        {
          stream.next (v.sec);
          stream.next (v.nsec);
        }
      ...
      template<typename Stream>
        inline static void
        read (Stream& stream, NS_NaviCommon::Time& v)
        {
          stream.next (v.sec);
          stream.next (v.nsec);
        }
      ...
      inline static uint32_t
      serializedLength (const NS_NaviCommon::Time&)
      {
        return 8;
      }
    };
  ...
  template<>
    struct Serializer<NS_NaviCommon::Duration>
    {
      template<typename Stream>
        inline static void
        write (Stream& stream, const NS_NaviCommon::Duration& v)
        {
          stream.next (v.sec);
          stream.next (v.nsec);
        }
      ...
      template<typename Stream>
        inline static void
        read (Stream& stream, NS_NaviCommon::Duration& v)
        {
          stream.next (v.sec);
          stream.next (v.nsec);
        }
      ...
      inline static uint32_t
      serializedLength (const NS_NaviCommon::Duration&)
      {
        return 8;
      }
    };
  ...
  template<typename T, class ContainerAllocator>
        ...
        typename boost::disable_if<NS_NaviCommon::IsFixedSize<T> >::type>
    {
      ...
      template<typename Stream>
        inline static void
        write (Stream& stream, const VecType& v)
        {
      ...
      inline static uint32_t
      serializedLength (const VecType& v)
      {
        uint32_t size = 4;
        ConstIteratorType it = v.begin ();
        ConstIteratorType end = v.end ();
  ...
  template<typename T, class ContainerAllocator, typename Stream>
    inline void
    serialize (Stream& stream, const std::vector<T, ContainerAllocator>& t)
    {
  ...
  template<typename T, class ContainerAllocator, typename Stream>
    inline void
    deserialize (Stream& stream, std::vector<T, ContainerAllocator>& t)
    {
  ...
  template<typename T, class ContainerAllocator>
    inline uint32_t
    serializationLength (const std::vector<T, ContainerAllocator>& t)
    {
  ...
  template<typename T, size_t N>
        ...
        typename boost::disable_if<NS_NaviCommon::IsFixedSize<T> >::type>
    {
      ...
      template<typename Stream>
        inline static void
        write (Stream& stream, const ArrayType& v)
        {
          ConstIteratorType it = v.begin ();
          ConstIteratorType end = v.end ();
          for (; it != end; ++it)
      ...
      template<typename Stream>
        inline static void
        read (Stream& stream, ArrayType& v)
        {
          IteratorType it = v.begin ();
          IteratorType end = v.end ();
          for (; it != end; ++it)
      ...
      inline static uint32_t
      serializedLength (const ArrayType& v)
      {
        uint32_t size = 0;
        ConstIteratorType it = v.begin ();
        ConstIteratorType end = v.end ();
  ...
  template<typename T, size_t N, typename Stream>
    inline void
    serialize (Stream& stream, const boost::array<T, N>& t)
    {
  ...
  template<typename T, size_t N, typename Stream>
    inline void
    deserialize (Stream& stream, boost::array<T, N>& t)
    {
  ...
  template<typename T, size_t N>
    inline uint32_t
    serializationLength (const boost::array<T, N>& t)
    {
   ...
   */
  template<typename M>
    inline SerializedMessage
    serializeMessage (const M& message)
    {
      SerializedMessage m;
  ...
  template<typename M>
    inline SerializedMessage
    serializeServiceResponse (bool ok, const M& message)
    {
      SerializedMessage m;
  ...
  template<typename M>
    inline void
    deserializeMessage (const SerializedMessage& m, M& message)
    {
...
// Additional serialization traits
  ...
  template<typename M>
    ...
    {
      static void
      notify (const PreDeserializeParams<M>&)
      {
      }
    };
