...
namespace NS_NaviCommon
{
  ...
  std::string Parameter::getParameter(const std::string node_name,
  ...
  int Parameter::getParameter(const std::string node_name,
  ...
  float Parameter::getParameter(const std::string node_name,
