...
namespace NS_Transform
{
  ...
  public:
    ...
    void setData(const NS_Transform::Transform& input)
    {
  ...
  static inline void quaternionMsgToTF(const NS_DataType::Quaternion& msg,
                                       Quaternion& bt)
  {
   ...
   */
  static inline NS_Transform::Quaternion createQuaternionFromRPY(double roll,
                                                                 double pitch,
                                                                 double yaw)
  {
    Quaternion q;
   ...
   * \return The quaternion constructed
   */
  static inline NS_DataType::Quaternion createQuaternionMsgFromRollPitchYaw(
  ...
  static inline void quaternionStampedMsgToTF(
      const NS_DataType::QuaternionStamped & msg, Stamped< Quaternion >& bt)
  {
  ...
  static inline void quaternionStampedTFToMsg(
      const Stamped< Quaternion >& bt, NS_DataType::QuaternionStamped & msg)
  {
  ...
  static inline void vector3MsgToTF(const NS_DataType::Vector3& msg_v,
                                    Vector3& bt_v)
  {
  ...
  static inline void vector3StampedMsgToTF(
      const NS_DataType::Vector3Stamped & msg, Stamped< Vector3 >& bt)
  {
  ...
  static inline void vector3StampedTFToMsg(const Stamped< Vector3 >& bt,
  ...
  static inline void pointMsgToTF(const NS_DataType::Point& msg_v, Point& bt_v)
  {
    bt_v = Vector3(msg_v.x, msg_v.y, msg_v.z);
  }
  ;
  /** \brief convert Point to Point msg*/
  static inline void pointTFToMsg(const Point& bt_v, NS_DataType::Point& msg_v)
  {
    msg_v.x = bt_v.x();
    msg_v.y = bt_v.y();
    msg_v.z = bt_v.z();
  ...
  static inline void pointStampedMsgToTF(const NS_DataType::PointStamped & msg,
                                         Stamped< Point >& bt)
  {
  ...
  static inline void pointStampedTFToMsg(const Stamped< Point >& bt,
  ...
  static inline void transformMsgToTF(const NS_DataType::Transform& msg,
                                      Transform& bt)
  {
    bt = Transform(
  ...
  static inline void transformStampedMsgToTF(
      const NS_DataType::TransformStamped & msg, StampedTransform& bt)
  {
  ...
  static inline void transformStampedTFToMsg(
      const StampedTransform& bt, NS_DataType::TransformStamped & msg)
  {
  ...
  static inline void poseStampedMsgToTF(const NS_DataType::PoseStamped & msg,
                                        Stamped< Pose >& bt)
  {
  ...
  static inline void poseStampedTFToMsg(const Stamped< Pose >& bt,
                                        NS_DataType::PoseStamped & msg)
  {
