...
#define TransformData TransformDoubleData
  ...
  public:
    ...
    explicit TFSIMD_FORCE_INLINE Transform(
        const Quaternion& q,
  ...
  TFSIMD_FORCE_INLINE Vector3 Transform::invXform(const Vector3& inVec) const
  {
    Vector3 v = inVec - m_origin;
    return (m_basis.transpose() * v);
  }

  TFSIMD_FORCE_INLINE Transform Transform::inverseTimes(
...
///for serialization
  ...
  TFSIMD_FORCE_INLINE void Transform::serializeFloat(
  ...
  TFSIMD_FORCE_INLINE void Transform::deSerializeFloat(
  ...
  TFSIMD_FORCE_INLINE void Transform::deSerializeDouble(
