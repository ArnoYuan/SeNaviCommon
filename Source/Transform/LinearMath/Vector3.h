...
#define Vector3DataName "Vector3DoubleData"
  ...
  public:
     ...
     * @param z Z value 
     */
    TFSIMD_FORCE_INLINE Vector3(const tfScalar& x, const tfScalar& y,
                                const tfScalar& z)
    {
      m_floats[0] = x;
      m_floats[1] = y;
    ...
    TFSIMD_FORCE_INLINE tfScalar triple(const Vector3& v1,
    ...
    {
      return
          m_floats[0] < m_floats[1] ? (m_floats[0] < m_floats[2] ? 0 : 2) : (
    ...
    {
      return
          m_floats[0] < m_floats[1] ? (m_floats[1] < m_floats[2] ? 2 : 1) : (
    ...
    TFSIMD_FORCE_INLINE void setInterpolate3(const Vector3& v0,
                                             const Vector3& v1, tfScalar rt)
    {
    ...
    {
      return m_floats[0] == tfScalar(0) && m_floats[1] == tfScalar(0) && m_floats[2] == tfScalar(
          0);
    }
  ...
  TFSIMD_FORCE_INLINE tfScalar tfTriple(const Vector3& v1, const Vector3& v2,
                                        const Vector3& v3)
  {
  ...
  TFSIMD_FORCE_INLINE Vector3 lerp(const Vector3& v1, const Vector3& v2,
                                   const tfScalar& t)
  {
    return v1.lerp(v2, t);
  }
  ...
  TFSIMD_FORCE_INLINE Vector3 Vector3::rotate(const Vector3& wAxis,
                                              const tfScalar angle) const
  {
  ...
  public:
    ...
    TFSIMD_FORCE_INLINE tfVector4(const tfScalar& x, const tfScalar& y,
...
///tfSwapVector3Endian swaps vector endianness, useful for network and cross-platform serialization
  TFSIMD_FORCE_INLINE void tfSwapScalarEndian(const tfScalar& sourceVal,
                                              tfScalar& destVal)
  {
...
///tfSwapVector3Endian swaps vector endianness, useful for network and cross-platform serialization
  TFSIMD_FORCE_INLINE void tfSwapVector3Endian(const Vector3& sourceVec,
                                               Vector3& destVec)
  {
    for(int i = 0; i < 4; i++)
    {
...
///tfUnSwapVector3Endian swaps vector endianness, useful for network and cross-platform serialization
  ...
  TFSIMD_FORCE_INLINE void tfPlaneSpace1(const Vector3& n, Vector3& p,
                                         Vector3& q)
  {
  ...
  TFSIMD_FORCE_INLINE void Vector3::serializeFloat(
  ...
  TFSIMD_FORCE_INLINE void Vector3::deSerializeFloat(
  ...
  TFSIMD_FORCE_INLINE void Vector3::serializeDouble(
  ...
  TFSIMD_FORCE_INLINE void Vector3::deSerializeDouble(
  ...
  TFSIMD_FORCE_INLINE void Vector3::deSerialize(
