...
namespace NS_Transform
{
  ...
  public:
    ...
    void setEuler(const tfScalar& yaw, const tfScalar& pitch,
                  const tfScalar& roll)
    {
    ...
    void setRPY(const tfScalar& roll, const tfScalar& pitch,
                const tfScalar& yaw)
    {
      tfScalar halfYaw = tfScalar(yaw) * tfScalar(0.5);
      tfScalar halfPitch = tfScalar(pitch) * tfScalar(0.5);
  ...
  TFSIMD_FORCE_INLINE Quaternion operator*(const Quaternion& q1,
                                           const Quaternion& q2)
  {
    return Quaternion(
  ...
  TFSIMD_FORCE_INLINE Quaternion operator*(const Vector3& w,
                                           const Quaternion& q)
  {
  ...
  TFSIMD_FORCE_INLINE tfScalar angleShortestPath(const Quaternion& q1,
                                                 const Quaternion& q2)
  {
  ...
  TFSIMD_FORCE_INLINE Quaternion slerp(const Quaternion& q1,
                                       const Quaternion& q2, const tfScalar& t)
  {
    return q1.slerp(q2, t);
  }

  TFSIMD_FORCE_INLINE Vector3 quatRotate(const Quaternion& rotation,
                                         const Vector3& v)
  {
  ...
  TFSIMD_FORCE_INLINE Quaternion shortestArcQuat(const Vector3& v0,
  ...
  TFSIMD_FORCE_INLINE Quaternion shortestArcQuatNormalize2(Vector3& v0,
                                                           Vector3& v1)
  {
    v0.normalize();
    v1.normalize();
