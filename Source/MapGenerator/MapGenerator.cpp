...
namespace NS_NaviCommon
{
  ...
  bool
  MapGenerator::saveMapInPGM (std::vector<char> map_data, int height, int width,
                              std::string pgm_file)
  {
  ...
  bool
  MapGenerator::readMapFromPGM (std::string pgm_file,
                                std::vector<char>& map_data, int& height,
                                int& width)
  {
  ...
  bool
  MapGenerator::addRobotPoseInMap (std::vector<char>& map_data, int map_height,
                                   int map_width, int robot_pose_x,
                                   int robot_pose_y)
  {
